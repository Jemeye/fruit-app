...
## Funcionalidades
- Inciar sesión y cerrar sesión: la aplicación le permite al usuario iniciar sesión mediante el formulario de login, y le permite cerrar sesión dándole click al botón de salir ubicado en el header.
